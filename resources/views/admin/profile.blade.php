        ...
        <div id="page-wrapper">
                <div class="row">
                    <div class="col-md-4 col-xs-12">
                        <div class="white-box">
                            <div class="user-bg"> <img width="100%" alt="user" src="/assetss/plugins/images/large/img1.jpg">
                                <div class="overlay-box">
                                    <div class="user-content">
                                        <a href="javascript:void(0)"><img src="/assetss/plugins/images/users/genu.jpg" class="thumb-lg img-circle" alt="img"></a>
