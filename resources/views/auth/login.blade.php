    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card border-primary mb-3">
                <div class="card-header text-white text-center bg-primary mb-3">{{ __('Masuk') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row mb-0">
                            ...
                            <div class="col-md-8 offset-md-4">
                                @if (Route::has('register')) <br>
                                <p>Jika tidak mempunyai akun silahkan klik<a class="btn btn-link"
