...
<body>
    ...
    <header id="header">
        <div class="container">
            ...
            <div id="logo" class="pull-left">
                <a href="/beranda"><img src="assets/img/logo2.png" alt="" title="" /></img></a>
            ...
            <nav id="nav-menu-container">
                <ul class="nav-menu">
                    ...
                    <li>
                        @if (Route::has('login'))
                        @auth
                        <a href="{{ url('/home') }}" class="nav-menu">Profil</a>
                        @else
  ...
  ============================-->
    <footer id="footer">
        ...
        <div class="container">
            <div class="copyright">
                &copy; Copyright <strong>SIDU BUSCARE</strong>. Teknik Rekayasa Perangkat Lunak B
            </div>
            <div class="credits">
                <!--
        ...
        -->
                Dibuat Oleh <a href="#hero">Kelompok 1B</a>
            </div>
        </div>
    </footer><!-- #footer -->
